...
public class FruitsBush extends Fruits {
    ...
    public FruitsBush(String name, Area area, String cultivationMethod, int lifetime, Soils[] soil, Interval planting, String[] care, Interval picking, Produce produce) {
